...
const Travel = () => (
  ...
  <div class="container px-5 py-24 mx-auto flex flex-wrap min-h-[100vh]">
    <div class="flex flex-wrap  mt-auto mb-auto lg:w-3/4 sm:w-2/3 content-start sm:pr-10  -ml-5 lg:-ml-18 ilg:-ml-20 ">
...
<div class="relative p-4  mx-5">
  <img class="object-cover w-48 lg:w-48 ilg:w-64 " src={Location1} alt="Your image"></img>
  <div class="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center">
    <h2 class="text-white  text-xl lg:text-2xl ilg:text-3xl  font-bold mb-4 -ml-8 mt-5 ilg:-mt-5 traveltitle">Beach<br></br> Getaways</h2>
    <p class="text-white text-sm lg:text-md ilg:text-lg mb-4 w-2/3 travelp">Relax on the white sands of the Caribbean or the turquoise waters of the Mediterranean.</p>
  </div>
</div>


<div class="relative p-4  mx-5">
  <img class="object-cover  w-48 lg:w-48 ilg:w-64 " src={Location2} alt="Your image"></img>
  <div class="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center">
    <h2 class="text-white text-xl lg:text-2xl ilg:text-3xl font-bold mb-4  -ml-8 mt-5 ilg:-mt-5 traveltitle">Adventure<br></br> Travel</h2>
...
<div class="relative p-4  mx-5">
  <img class="object-cover  w-48 lg:w-48 ilg:w-64 " src={Location3} alt="Your image"></img>
  <div class="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center">
    <h2 class="text-white text-xl lg:text-2xl ilg:text-3xl font-bold mb-4 -ml-10 mt-3 ilg:-mt-8 traveltitle">Cultural<br></br> Tours</h2>
