...
const SERVICE_ID = "service_u0bekpb";
const TEMPLATE_ID = "template_4gkyetc";
const USER_ID = "ULGwsERLCtsgf9qnl";
    ...
    <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
        ...
        <div
           ...
           <form onSubmit={handleSubmit}>
            ...
            <button
                className="text-white  border-0 py-3 px-6 focus:outline-none hover:bg-red-800  text-lg submitBtn" onSubmit={handleSubmit}>Send</button>
                </form>
