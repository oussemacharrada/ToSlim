...
const Services = () => (
  ...
  <div className={`bg-gray-300 h-[48rem] sm:h-[47.5rem] md:h-[47.5rem] lg:h-[44.4 rem]  ilg:h-[44.2rem] xl:h-[44.7rem] w-full   shadow-md bg-cover bg-blend-normal	 bg-center bg-event-pattern imgeffect`}></div>
  <div className="w-full sm:w-[26rem] md:w-[30rem] lg:w-[33rem]  ilg:w-[34rem] xl:w-[31rem] ml-0 sm:ml-16 md:ml-16 lg:ml-28 ilg:ml-64 xl:ml-48 bg-[#423F49]    h-[18rem] sm:h-[18rem] lg:h-[15rem]  -mt-48 shadow-lg overflow-hidden px-1 pb-20	">
    ...
    <div class="flex flex-col flex-wrap sm:py-6 -mb-10 sm:w-1/2 sm:pl-12 sm:text-left text-center mb-[1.5rem]">
      ...
      <div class="flex flex-col  sm:items-start items-center mb-[1.5rem]">
        <div class="flex-grow">
        <div className="w-full sm:w-[24rem] md:w-[24rem] lg:w-[30.5rem]  ilg:w-[34rem] xl:w-[36rem] bg-[#99232F]    h-[18rem] sm:h-[18rem] lg:h-[15rem]     shadow-lg overflow-hidden  pl-8">
        <div className="py-4  p-6">
      ...
      <div class="flex flex-col  sm:items-start items-center ml-0 sm:ml-12 md:ml-20 lg:ml-16 ilg:ml-24 xl:ml-16 mt-[1.5rem] shadow-lg bg-[#F4EDE5] "> 
        <div class="flex-grow">
        <div className="w-full sm:w-[24rem] md:w-[24rem] lg:w-[30.5rem]  ilg:w-[34rem] xl:w-[36rem]    h-[18rem] sm:h-[18rem] lg:h-[15rem]    overflow-hidden  pl-8	">
    <div className="py-4  p-6">
